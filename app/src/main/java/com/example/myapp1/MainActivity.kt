...
class MainActivity : AppCompatActivity() {
    ...
    private fun isiGambar( txtHello: TextView, image1: ImageView){
        ...
        when (tes) {
            1 -> image1.setImageDrawable(getDrawable(R.drawable.ironman1))
            2 -> image1.setImageDrawable(getDrawable(R.drawable.ironman2))
            3 -> image1.setImageDrawable(getDrawable(R.drawable.ironman3))
            4 -> image1.setImageDrawable(getDrawable(R.drawable.ironman4))
            5 -> image1.setImageDrawable(getDrawable(R.drawable.ironman5))
            else -> { // Note the block
                image1.setImageDrawable(getDrawable(R.drawable.ironman6))
            }
        }
    }
